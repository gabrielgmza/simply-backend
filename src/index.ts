...
import backofficePhase4Routes from './routes/backofficePhase4Routes';
import backofficeDashboardRoutes from './routes/backofficeDashboardRoutes';
...
// Backoffice API Phase 4 (RBAC, Aria AI, Approvals, Sessions)
app.use('/api/backoffice', backofficePhase4Routes);

// Backoffice API Dashboard & Rewards
app.use('/api/backoffice', backofficeDashboardRoutes);

// Stripe (PIX, Crypto) & BCRA (USD, Deudores)
app.use('/api', stripeRoutes);

// Employee Management & User History
app.use('/api/backoffice', employeeManagementRoutes);

// Mobile App Routes (Onboarding, Dashboard, Transfers, Contacts, Notifications)
app.use('/api/app', mobileRoutes);

// Security Routes (Trust Score, Risk-Based Auth, Kill Switch, Fraud Detection)
app.use('/api/security', securityRoutes);
app.use('/api/backoffice/security', securityRoutes);
...
app.get('/', (req, res) => {
  res.json({
    ...
    features: {
      ...
      security: 'Trust Score, Risk-Based Auth, Kill Switch, Behavioral Analytics'
    },
    env: {
...
app.listen(port, '0.0.0.0', async () => {
  ...
  console.log(`   Phase 4: RBAC/ABAC, Aria AI Agent, Dual Authorization, Session Management`);
  console.log(`   Phase 5: Stripe (PIX, Crypto Onramp), BCRA (USD, Central Deudores)`);
  console.log(`   Phase 6: Employee Management (block/unblock/delete), User History, Legajo`);
  console.log(`   Phase 7: Mobile App Ready - Transfers, CVU Generation, Dashboard, Onboarding, Push Notifications`);
  console.log(`\n`);
});
